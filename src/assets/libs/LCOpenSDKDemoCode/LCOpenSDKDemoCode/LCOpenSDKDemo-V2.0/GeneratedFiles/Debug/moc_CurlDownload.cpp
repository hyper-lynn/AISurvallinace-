...
QT_MOC_LITERAL(6, 54, 8) // "deviceId"

    },
    "CurlDownload\0sgnFinished\0\0unsigned char*\0"
    "data\0dataLen\0deviceId"
};
...
static const uint qt_meta_data_CurlDownload[] = {
 ...
 // signals: parameters
    QMetaType::Void, 0x80000000 | 3, QMetaType::UInt, QMetaType::QString,    4,    5,    6,
...
void CurlDownload::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sgnFinished((*reinterpret_cast< unsigned char*(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CurlDownload::*)(unsigned char * , unsigned int , QString );
...
// SIGNAL 0
void CurlDownload::sgnFinished(unsigned char * _t1, unsigned int _t2, QString _t3)
{
