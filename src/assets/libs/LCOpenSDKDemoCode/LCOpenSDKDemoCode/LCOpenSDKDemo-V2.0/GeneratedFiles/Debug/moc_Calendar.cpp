...
QT_MOC_LITERAL(1, 9, 10), // "sgnClicked"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "Calendar\0sgnClicked\0"
};
...
void Calendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sgnClicked((*reinterpret_cast< QDate(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Calendar::*)(QDate );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Calendar::sgnClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Calendar::sgnClicked(QDate _t1)
{
