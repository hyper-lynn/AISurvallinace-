...
rem Usage : gen_svninfo_header.bat [header file name [svn path]] 
rem set PYTHONPATH=./;%PYTHONPATH%
rem python -c "import dslct; gen_svninfo_header( %1, %2 )"
python ..\Depend\dslct.py gen_svninfo_header %1 %2
