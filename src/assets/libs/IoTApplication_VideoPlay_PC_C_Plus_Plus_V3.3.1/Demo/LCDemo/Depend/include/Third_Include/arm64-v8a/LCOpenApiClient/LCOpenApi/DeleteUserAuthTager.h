...
namespace LCOpenApi{
	...
	typedef DeleteUserAuthTagerRequest::DeleteUserAuthTagerRequestData DeleteUserAuthTagerRequestData;
	...
	typedef DeleteUserAuthTagerResponse::DeleteUserAuthTagerResponseData DeleteUserAuthTagerResponseData;
