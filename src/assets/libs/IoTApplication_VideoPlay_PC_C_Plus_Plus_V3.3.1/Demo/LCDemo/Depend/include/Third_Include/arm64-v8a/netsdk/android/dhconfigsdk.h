...
///@brief 事件类型 EVENT_IVS_PRISONERRISEDETECTION (起身检测事件)对应的规则配置
...
typedef struct tagTrafficEventCheckInfo
{
    ...
    BOOL                abPrisonerRiseDetection;        // 是否携带囚犯起身检测信息
    EM_CHECK_TYPE       emPrisonerRiseDetection;        // 囚犯起身检测检测类型
...
typedef struct tagTrafficEventCheckMask
{
    ...
    BOOL                abPrisonerRiseDetection;        // 是否携带囚犯起身检测信息
    int                 nPrisonerRiseDetection;         // 囚犯起身检测检测模式掩码
...
typedef struct tagViolationTimeSchedule
{
    ...
    BOOL                abPrisonerRiseDetection;        // 是否携带囚犯起身检测信息
    TIME_SCHEDULE_INFO  stPrisonerRiseDetection;        // 囚犯起身检测时间配置
