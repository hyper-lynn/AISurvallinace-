...
<root>
	...
	<type>登录类型，1:Web客户端登录 2:手机客户端登录 3:PC客户端登录</type>
...
@param [in]	 srctype		查询条件标识 1 是组织 2 是设备
...
<root>
	<task taskid="" userid ="" taskname ="" wndnum ="" tasktype ="" time="" parentdomid="" parentcode="" >
        <channel id="0" taskid="0" domid ="" devcode ="" devtype="" devname="" substream="" timespan="" prepoint="" index="" />
 		<channel id="0" taskid="0" domid ="" devcode ="" devtype="" devname="" substream="" timespan="" prepoint="" index="" />
	</task>
	<task taskid="" userid ="" taskname ="" wndnum ="" tasktype ="" time="" parentdomid="" parentcode="" >
        <channel id="0" taskid="0" domid ="" devcode ="" devtype="" devname="" substream="" timespan="" prepoint="" index="" />
