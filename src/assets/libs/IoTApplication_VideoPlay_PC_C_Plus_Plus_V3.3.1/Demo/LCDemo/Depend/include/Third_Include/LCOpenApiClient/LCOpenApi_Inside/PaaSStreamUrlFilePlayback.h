 ...
 *  SVN Rev: 228333, Author: 251672, Date: 2025-03-22 15:37:42 +0800 
 *  SHOULD NOT MODIFY!
 */
...
typedef struct PaaSStreamUrlFilePlaybackRequest 
{
	LCOpenApiRequest base;

	struct PaaSStreamUrlFilePlaybackRequestData
	{
		
		/** struct of PaaSStreamUrlFilePlaybackRequestData_ControlInfo */
		struct PaaSStreamUrlFilePlaybackRequestData_ControlInfo {
			/** [double] 负数表示倒放(功能暂不支持),可选,默认值1.0 ,当参数为负数时,已下游处理为准 */
			double speed;
			/** struct of PaaSStreamUrlFilePlaybackRequestData_ControlInfo_Passthrough */
			struct PaaSStreamUrlFilePlaybackRequestData_ControlInfo_Passthrough {
...
C_API PaaSStreamUrlFilePlaybackRequest *LCOPENAPI_INIT(PaaSStreamUrlFilePlaybackRequest);

typedef struct PaaSStreamUrlFilePlaybackResponse 
{
	LCOpenApiResponse base;

	struct PaaSStreamUrlFilePlaybackResponseData
	{
...
C_API PaaSStreamUrlFilePlaybackResponse *LCOPENAPI_INIT(PaaSStreamUrlFilePlaybackResponse);
