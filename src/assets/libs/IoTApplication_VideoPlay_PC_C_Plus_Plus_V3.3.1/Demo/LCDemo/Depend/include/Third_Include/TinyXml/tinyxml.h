...
/// 增加定义宏TIXML_USE_STL TIXML_NEED_STREAM
/// 外部调用时无需再定义这两个宏， add by dlc, 2011-12-2
#ifndef TIXML_USE_STL
#define TIXML_USE_STL
#endif

#ifndef TIXML_NEED_STREAM
...
/*	A class used to manage a group of attributes.
	...
	This version is implemented with circular lists because:
		...
		- it demonstrates some from the (typical) doubly linked list.
*/
...
/// added BEGIN
/// by liu_ding@dahuatech.com
/// 主要解决当<ErrCode>400</ErrCode > 结束tag中含有空格不能解析的问题
private:
    void GetEndTagSkipSpace(const char *p, TIXML_STRING& _endTag, TiXmlEncoding encoding);
/// added END
private:
