...
class INTERFACE_API_CLASS IReferable
{
protected:
    ...
    IReferable& operator =( const IReferable& ){ return *this;};
...
/////////////////////////////////////////////////////////////////////*/
class INTERFACE_API_CLASS CBaseReferablePtr
{
protected:
    IReferable* mRefPtr;
...
template <typename X>
class INTERFACE_API_CLASS CReferablePtr : public CBaseReferablePtr
{
public:
...
template<typename X>
class INTERFACE_API_CLASS CReferableObj : public CBaseReferablePtr
{
public:
...
/////////////////////////////////////////////////////////////////////*/
template<typename X>
class INTERFACE_API_CLASS CReferable : public IReferable
{
protected:
    //ensure not be alloced from stack, or refer crashed
...
NAMESPACE_END // End of namespace DHTools
