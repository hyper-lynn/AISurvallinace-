...
class INTERFACE_API_CLASS CReadWriteMutex  
{
protected:
    int m_nReadCount;
    Mutex m_CrtRead;
...
class INTERFACE_API_CLASS CReadWriteMutexLock
{
public:
    ...
    virtual void Unlock();
protected: 
    CReadWriteMutexLock( const CReadWriteMutexLock &rhs );
    CReadWriteMutexLock& operator=( const CReadWriteMutexLock &rhs );
