...
#ifndef _HSVIEW_CLIENT_API_GetGroupDeviceListByPage_H_
#define _HSVIEW_CLIENT_API_GetGroupDeviceListByPage_H_
...
typedef struct GetGroupDeviceListByPageRequest 
{
	HsviewRequest base;

	struct GetGroupDeviceListByPageRequestData
	{
...
} GetGroupDeviceListByPageRequest;

C_API GetGroupDeviceListByPageRequest *HSAPI_INIT(GetGroupDeviceListByPageRequest);

typedef struct GetGroupDeviceListByPageResponse 
{
	HsviewResponse base;

	struct GetGroupDeviceListByPageResponseData
	{
		
		/** define a list with struct of GetGroupDeviceListByPageResponseData_DevicesElement */
		DECLARE_LIST(struct GetGroupDeviceListByPageResponseData_DevicesElement
		{
			/** define a list with struct of GetGroupDeviceListByPageResponseData_DevicesElement_ChannelsElement */
			DECLARE_LIST(struct GetGroupDeviceListByPageResponseData_DevicesElement_ChannelsElement
			{
				/** struct of GetGroupDeviceListByPageResponseData_DevicesElement_ChannelsElement_ContentEncrypt */
				struct GetGroupDeviceListByPageResponseData_DevicesElement_ChannelsElement_ContentEncrypt {
					/** 密钥生成算法版本号 */
					CSTR ruleVersion;
					/** 内容加密模式 */
					CSTR encryptMode;
...
} GetGroupDeviceListByPageResponse;

C_API GetGroupDeviceListByPageResponse *HSAPI_INIT(GetGroupDeviceListByPageResponse);
