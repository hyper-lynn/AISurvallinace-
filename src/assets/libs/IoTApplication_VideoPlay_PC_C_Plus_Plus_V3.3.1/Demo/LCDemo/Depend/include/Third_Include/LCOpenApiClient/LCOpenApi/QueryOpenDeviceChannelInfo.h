...
typedef struct QueryOpenDeviceChannelInfoRequest 
{
	LCOpenApiRequest base;

	struct QueryOpenDeviceChannelInfoRequestData
	{
...
C_API QueryOpenDeviceChannelInfoRequest *LCOPENAPI_INIT(QueryOpenDeviceChannelInfoRequest);

typedef struct QueryOpenDeviceChannelInfoResponse 
{
	LCOpenApiResponse base;

	struct QueryOpenDeviceChannelInfoResponseData
	{
		
		/** define a list with struct of QueryOpenDeviceChannelInfoResponseData_DevicesElement */
		DECLARE_LIST(struct QueryOpenDeviceChannelInfoResponseData_DevicesElement
		{
			...
			DECLARE_LIST(struct QueryOpenDeviceChannelInfoResponseData_DevicesElement_ChannelsElement
			{
...
C_API QueryOpenDeviceChannelInfoResponse *LCOPENAPI_INIT(QueryOpenDeviceChannelInfoResponse);
