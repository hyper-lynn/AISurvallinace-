...
class DOAX_DEPRECATED CLogRecord
{
public:
...
class DOAX_DEPRECATED CLogHandler
{
public:
...
class DOAX_DEPRECATED CFileLogHandler : public CLogHandler
{
public:
...
private:
	...
	//static int _controlcout; //只是为了控制不关闭控制台输出，没有必要，gaowei 09-07-28
	static bool m_forceFlush;
	//AX_Mutex mutex;
};

class DOAX_DEPRECATED CLogger
{
public:
