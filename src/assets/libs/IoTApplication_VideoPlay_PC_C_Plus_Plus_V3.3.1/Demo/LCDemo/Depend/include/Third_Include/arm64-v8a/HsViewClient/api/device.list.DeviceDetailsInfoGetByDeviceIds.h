...
#ifndef _HSVIEW_CLIENT_API_deviceList_DeviceDetailsInfoGetByDeviceIds_H_
#define _HSVIEW_CLIENT_API_deviceList_DeviceDetailsInfoGetByDeviceIds_H_
...
注：当请求用户对所有设备有权限时，才正常返回。

[paas协议](https://paas.dahuatech.com/wiki/?p=%2FSaaStoPaaS%2F%E8%AE%BE%E5%A4%87%E7%AE%A1%E7%90%86%2Fcloud.device.DeviceDetailInfoGetByDeviceIds&s=pj)

【需要使用平台账号签名】
 */

typedef struct deviceList_DeviceDetailsInfoGetByDeviceIdsRequest 
{
	HsviewRequest base;

	struct deviceList_DeviceDetailsInfoGetByDeviceIdsRequestData
	{
		
		/** define a list with struct of deviceList_DeviceDetailsInfoGetByDeviceIdsRequestData_DeviceListElement */
		DECLARE_LIST(struct deviceList_DeviceDetailsInfoGetByDeviceIdsRequestData_DeviceListElement
		{
			/** 配件Id */
...
} deviceList_DeviceDetailsInfoGetByDeviceIdsRequest;

C_API deviceList_DeviceDetailsInfoGetByDeviceIdsRequest *HSAPI_INIT(deviceList_DeviceDetailsInfoGetByDeviceIdsRequest);

typedef struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponse 
{
	HsviewResponse base;

	struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData
	{
		
		/** define a list with struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement */
		DECLARE_LIST(struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement
		{
			...
			CSTR deviceUsername;
			/** struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_WifiState */
			struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_WifiState {
				/** [O]WIFI名称,如TP-link */
				CSTR ssId;
				/** [O]强度,0最弱,5最强 */
				CSTR intensity;
			...
			CSTR ability;
			/** define a list with struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_AplistElement */
			DECLARE_LIST(struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_AplistElement
			{
				...
				/** 配件名称 */
				CSTR apName;
				/** struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_AplistElement_ApState */
				struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_AplistElement_ApState {
					/** [O]上报时间,yyyyMMddTHHmmss时间格式 */
					CSTR reportTime;
					/** [O]电量百分比强度 */
					CSTR electric;
			...
			/** define a list with struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_ChannelsElement */
			DECLARE_LIST(struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_ChannelsElement
			{
				...
				/** [O]被分享和授权的备注（saas）,海外SMB需求,shareStatus字段为share，auth，shareAndAuth时关注该字段的值 */
				CSTR shareRemark;
				/** struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_ChannelsElement_WifiState */
				struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_ChannelsElement_WifiState {
					/** [O]WIFI名称,如TP-link */
					CSTR ssId;
					/** [O]强度,0最弱,5最强 */
					CSTR intensity;
				...
				/** [O]遮罩状态，on-打开 off-关闭 */
				CSTR cameraStatus;
				/** struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_ChannelsElement_ElectricState */
				struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_ChannelsElement_ElectricState {
			...
			/** [O]设备Rtsp端口,海外使用 */
			CSTR rtspPort;
			/** struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_ElectricState */
			struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_ElectricState {
				/** [O]电量百分比,取值范围0-100,-1设备无该电池 */
				CSTR electric;
				/** [O]碱性电池电量百分比,取值范围0-100,-1设备无该电池 */
				CSTR alkElec;
			...
			CSTR brand;
			/** struct of deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_NetworkSignal */
			struct deviceList_DeviceDetailsInfoGetByDeviceIdsResponseData_DeviceListElement_NetworkSignal {
				/** [O]强度。单位为dbm */
				CSTR sigStrength;
			...
			/** [O]支持的WiFi频段: 2.4Ghz,5Ghz，逗号分隔 */
			CSTR wifiTransferModel;
...
} deviceList_DeviceDetailsInfoGetByDeviceIdsResponse;

C_API deviceList_DeviceDetailsInfoGetByDeviceIdsResponse *HSAPI_INIT(deviceList_DeviceDetailsInfoGetByDeviceIdsResponse);
