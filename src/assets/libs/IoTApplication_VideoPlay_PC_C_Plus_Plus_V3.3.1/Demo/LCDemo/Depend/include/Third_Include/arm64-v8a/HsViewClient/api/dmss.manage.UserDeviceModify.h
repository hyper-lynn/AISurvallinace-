...
#ifndef _HSVIEW_CLIENT_API_dmssManage_UserDeviceModify_H_
#define _HSVIEW_CLIENT_API_dmssManage_UserDeviceModify_H_
...
typedef struct dmssManage_UserDeviceModifyRequest 
{
	HsviewRequest base;

	struct dmssManage_UserDeviceModifyRequestData
	{
...
} dmssManage_UserDeviceModifyRequest;

C_API dmssManage_UserDeviceModifyRequest *HSAPI_INIT(dmssManage_UserDeviceModifyRequest);

typedef struct dmssManage_UserDeviceModifyResponse 
{
	HsviewResponse base;

	struct dmssManage_UserDeviceModifyResponseData
	{
...
} dmssManage_UserDeviceModifyResponse;

C_API dmssManage_UserDeviceModifyResponse *HSAPI_INIT(dmssManage_UserDeviceModifyResponse);
