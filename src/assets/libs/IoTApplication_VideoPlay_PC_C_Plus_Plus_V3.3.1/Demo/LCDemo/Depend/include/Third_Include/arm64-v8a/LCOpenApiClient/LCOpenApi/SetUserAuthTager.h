...
namespace LCOpenApi{
	...
	typedef SetUserAuthTagerRequest::SetUserAuthTagerRequestData SetUserAuthTagerRequestData;
	...
	typedef SetUserAuthTagerResponse::SetUserAuthTagerResponseData SetUserAuthTagerResponseData;
