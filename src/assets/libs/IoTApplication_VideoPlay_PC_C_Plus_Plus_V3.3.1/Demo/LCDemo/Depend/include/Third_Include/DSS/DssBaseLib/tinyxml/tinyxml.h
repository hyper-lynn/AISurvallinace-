...
#ifndef DSL_TINYXML_INCLUDED
#define DSL_TINYXML_INCLUDED
...
//#ifdef _SAVESTRING
	...
	bool DocToString(char * xmlstr) ;  // not safe, don't use, limit 1G len
