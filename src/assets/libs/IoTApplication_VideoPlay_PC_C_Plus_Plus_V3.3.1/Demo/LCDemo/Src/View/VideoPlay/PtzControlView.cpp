...
int PtzControlView::init()
{
    ...
    do 
    {
        ...
        m_btnArrow = new IconBtn(this, "Skin/real-time vedio/PTZ/yuntai_icon_unfold_up");
        if (NULL == m_btnArrow)
        {
            ret = -1;
            break;
        ...
        m_btnUp = new IconBtn(m_labelShadow, "Skin/real-time vedio/PTZ/up", ICON_STATUS_DEFAULT | ICON_TYPE_MASK | ICON_TYPE_LONGPRESS);
        m_btnLeft = new IconBtn(m_labelShadow, "Skin/real-time vedio/PTZ/left", ICON_STATUS_DEFAULT | ICON_TYPE_MASK | ICON_TYPE_LONGPRESS);
        m_btnDown = new IconBtn(m_labelShadow, "Skin/real-time vedio/PTZ/down", ICON_STATUS_DEFAULT | ICON_TYPE_MASK | ICON_TYPE_LONGPRESS);
        m_btnRight = new IconBtn(m_labelShadow, "Skin/real-time vedio/PTZ/right", ICON_STATUS_DEFAULT | ICON_TYPE_MASK | ICON_TYPE_LONGPRESS);
        m_btnLeftUp = new IconBtn(m_labelShadow, "Skin/real-time vedio/PTZ/upl", ICON_STATUS_DEFAULT | ICON_TYPE_MASK | ICON_TYPE_LONGPRESS);
        m_btnLeftDown = new IconBtn(m_labelShadow, "Skin/real-time vedio/PTZ/downl", ICON_STATUS_DEFAULT | ICON_TYPE_MASK | ICON_TYPE_LONGPRESS);
        m_btnRightUp = new IconBtn(m_labelShadow, "Skin/real-time vedio/PTZ/upr", ICON_STATUS_DEFAULT | ICON_TYPE_MASK | ICON_TYPE_LONGPRESS);
        m_btnRightDown = new IconBtn(m_labelShadow, "Skin/real-time vedio/PTZ/downr", ICON_STATUS_DEFAULT | ICON_TYPE_MASK | ICON_TYPE_LONGPRESS);
...
void PtzControlView::refreshLayout()
{
	...
	m_labelTitle->setText("PTZ");
    m_labelTitle->adjustSize();
    m_labelTitle->move(12, (32 - m_labelTitle->height()) / 2);

    m_btnArrow->setIconPath("Skin/real-time vedio/PTZ/yuntai_icon_unfold_" + (m_showWhole ? QString("down") : QString("up")));
    m_btnArrow->setPosition(QPoint(this->width() - 6 - m_btnArrow->width(), (32 - m_btnArrow->height()) / 2));

    QPixmap pixmap;
    pixmap.load("Skin/real-time vedio/PTZ/shadow.png");
    ...
    pixmap.load("Skin/real-time vedio/PTZ/circle.png");
