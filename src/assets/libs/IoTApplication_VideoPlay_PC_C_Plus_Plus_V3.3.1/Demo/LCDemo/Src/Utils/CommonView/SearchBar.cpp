...
int SearchBar::init()
{
	...
	m_textEdit->setPlaceholderText("--Please Choose--");
	...
	//m_searchBtn->setBtnAttribute("Skin/vedio_icon_search", tr("Query"), 11, QColor(0xB0AFAF));
	m_searchBtn->setBtnAttribute("Skin/vedio_icon_search", "Query", 11, QColor(0xB0AFAF));
