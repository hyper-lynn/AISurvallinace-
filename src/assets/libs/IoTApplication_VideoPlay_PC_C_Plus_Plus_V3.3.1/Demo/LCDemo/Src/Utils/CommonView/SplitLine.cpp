...
SplitLine::SplitLine(QWidget *parent, const QColor &colorOver, const QColor &colorBelow, int height)
    : QWidget(parent)
{
    init();
...
SplitLine::SplitLine(QWidget *parent, const QColor &color, int height)
: QWidget(parent)
{
    init();
...
void SplitLine::createSplitLine(const QColor &colorOver, const QColor &colorBelow, int height)
{
