...
QT_MOC_LITERAL(1, 10, 10), // "sgnFocusIn"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11), // "sgnFocusOut"
QT_MOC_LITERAL(4, 34, 9), // "sgnSearch"
QT_MOC_LITERAL(5, 44, 8), // "dateTime"
QT_MOC_LITERAL(6, 53, 10) // "slotSearch"

    },
    "SearchBar\0sgnFocusIn\0\0sgnFocusOut\0"
    "sgnSearch\0dateTime\0slotSearch"
};
...
void SearchBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sgnSearch((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::sgnFocusIn)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SearchBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::sgnFocusOut)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::sgnSearch)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SearchBar::sgnFocusIn()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SearchBar::sgnFocusOut()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SearchBar::sgnSearch(QString _t1)
{
