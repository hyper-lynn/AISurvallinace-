...
QT_MOC_LITERAL(1, 11, 13), // "sgnMouseEvent"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 6), // "widget"
QT_MOC_LITERAL(4, 33, 7), // "isEnter"
QT_MOC_LITERAL(5, 41, 10) // "sgnClicked"

    },
    "BaseWidget\0sgnMouseEvent\0\0widget\0"
    "isEnter\0sgnClicked"
};
...
static const uint qt_meta_data_BaseWidget[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::VoidStar, QMetaType::Bool,    3,    4,
    QMetaType::Void,
...
void BaseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sgnMouseEvent((*reinterpret_cast< void*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 1: _t->sgnClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BaseWidget::*)(void * , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseWidget::sgnMouseEvent)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseWidget::sgnClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void BaseWidget::sgnMouseEvent(void * _t1, bool _t2)
{
